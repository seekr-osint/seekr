...
var requests = Requests{
	...
	"5-email": { // ID 10
		...
		ExpectedResponse:           map[string]interface{}{"accounts": map[string]interface{}{}, "custom": interface{}(nil), "gender": "", "address": "", "age": float64(10), "bday": "", "civilstatus": "", "club": "", "education": "", "email": map[string]interface{}{"fsdfadsfasdfasdf@gmail.com": map[string]interface{}{"mail": "fsdfadsfasdfasdf@gmail.com", "provider": "gmail", "services": map[string]interface{}{}, "src": "", "valid": true, "value": float64(0), "skipped_services": map[string]interface{}{}}}, "hobbies": "", "id": "10", "kids": "", "legal": "", "maidenname": "", "military": "", "name": "Email test", "notaccounts": interface{}(nil), "notes": "", "occupation": "", "pets": "", "phone": map[string]interface{}{}, "pictures": map[string]interface{}{}, "political": "", "prevoccupation": "", "relations": map[string]interface{}{}, "religion": "", "sources": map[string]interface{}{}, "ssn": map[string]interface{}{}, "tags": []interface{}{}},
		StatusCode:                 201,
	...
	"7a-emailServices": { // ID 11
		...
		ExpectedResponse:           map[string]interface{}{"accounts": map[string]interface{}{}, "address": "", "gender": "", "custom": interface{}(nil), "age": float64(10), "bday": "", "civilstatus": "", "club": "", "education": "", "email": map[string]interface{}{"has_discord_account@gmail.com": map[string]interface{}{"mail": "has_discord_account@gmail.com", "provider": "fake_mail", "services": map[string]interface{}{"Discord": map[string]interface{}{"icon": "./images/mail/discord.png", "link": "", "name": "Discord", "username": ""}}, "src": "", "valid": true, "value": float64(0), "skipped_services": map[string]interface{}{}}}, "hobbies": "", "id": "11", "kids": "", "legal": "", "maidenname": "", "military": "", "name": "Email test", "notaccounts": interface{}(nil), "notes": "", "occupation": "", "pets": "", "phone": map[string]interface{}{}, "pictures": map[string]interface{}{}, "political": "", "prevoccupation": "", "relations": map[string]interface{}{}, "religion": "", "sources": map[string]interface{}{}, "ssn": map[string]interface{}{}, "tags": []interface{}{}},
		StatusCode:                 201,
		RequiresInternetConnection: true,
	},
	...
	"7d-fakeEmail": { // ID 14
		...
		ExpectedResponse:           map[string]interface{}{"accounts": map[string]interface{}{}, "address": "", "custom": interface{}(nil), "gender": "", "age": float64(10), "bday": "", "civilstatus": "", "club": "", "education": "", "email": map[string]interface{}{"fake_mail@gmail.com": map[string]interface{}{"mail": "fake_mail@gmail.com", "provider": "fake_mail", "services": map[string]interface{}{}, "skipped_services": map[string]interface{}{}, "src": "", "valid": true, "value": float64(0)}}, "hobbies": "", "id": "14", "kids": "", "legal": "", "maidenname": "", "military": "", "name": "Email test", "notaccounts": interface{}(nil), "notes": "", "occupation": "", "pets": "", "phone": map[string]interface{}{}, "pictures": map[string]interface{}{}, "political": "", "prevoccupation": "", "relations": map[string]interface{}{}, "religion": "", "sources": map[string]interface{}{}, "ssn": map[string]interface{}{}, "tags": []interface{}{}},
		StatusCode:                 201,
		RequiresInternetConnection: true,
	},
	"8a-accounts": { // ID 15
	...
	"9e-postPerson": { // ID 18
		...
		URL:         "http://localhost:8080/person",
		PostData: map[string]interface{}{"id": "18", "ssn": map[string]interface{}{
			"fd": map[string]interface{}{"ssn": "fd"},
		}},
